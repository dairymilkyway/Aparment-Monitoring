<?php
 ...
 $rented_room_query = "SELECT r.room_number, r.price, rr.date_approved, rr.due_date, p.amount 
 FROM rooms r 
...
$rented_rooms = $rented_room_stmt->fetchAll(PDO::FETCH_ASSOC);
...
<body>
    <div class="container">
        ...
        <!-- Replace the rented rooms section around line 103 with this code -->
        <section class="dashboard-section">
            ...
            <div class="room-grid">
                <?php foreach($rented_rooms as $index => $rented_roomer): ?>
                    <div class="room-card rented" onclick="showRentedRoomDetails(<?php echo $index; ?>)">
                        <div class="room-number"><?php echo htmlspecialchars($rented_roomer['room_number']); ?></div>
                        <div class="room-price">₱<?php echo htmlspecialchars($rented_roomer['price']); ?>/mo</div>
